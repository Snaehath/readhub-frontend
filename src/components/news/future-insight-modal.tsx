        ...
        <div className="hidden md:block w-[50%] relative flex-shrink-0 group overflow-hidden border-r border-zinc-100 dark:border-zinc-800">
          ...
          <div className="absolute inset-x-0 bottom-0 p-12 space-y-6">
            <div className="flex flex-wrap items-center gap-3">
              <div className="px-4 py-1.5 rounded-full bg-emerald-500 text-white font-bold text-sm uppercase">
          ...
          <div className="flex-1 overflow-y-auto p-6 sm:p-12 pt-4 space-y-4 bg-zinc-50/10 dark:bg-zinc-900/5">
            ...
            <div className="md:hidden relative h-72 rounded-xl overflow-hidden mb-8 shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 space-y-3">
                <div className="bg-emerald-600 text-[10px] font-black uppercase tracking-widest text-white px-3 py-1 w-fit rounded-full">
                  {article.source?.name}
                </div>
                <Typography
                  variant="h3"
            ...
            <section className="space-y-4">
              ...
              {!token ? (
                <div className="py-20 text-center space-y-8 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-3xl">
                  <div className="inline-flex bg-emerald-50 dark:bg-emerald-950/30 p-6 rounded-full">
                  ...
                  <div className="space-y-3 max-w-sm mx-auto p-4">
                    ...
                    >
                      Authenticate to grant our AI agent full access to project
                ...
                <div className="py-24 flex flex-col items-center justify-center gap-8">
                  ...
                  >
                    AI Agent is Predicting
                  </Typography>
                </div>
              ) : insightError ? (
                <div className="py-12 px-6 text-center space-y-4 border-2 border-red-100 dark:border-red-900/30 bg-red-50/50 dark:bg-red-950/10 rounded-3xl">
                  <div className="inline-flex bg-red-100 dark:bg-red-950/50 p-4 rounded-full">
                ...
                <div className="animate-in fade-in slide-in-from-bottom-6 duration-1000">
                  <div className="prose dark:prose-invert max-w-none prose-sm sm:prose-base leading-loose text-foreground/85 font-medium">
                    <ReactMarkdown>{insightResponse}</ReactMarkdown>
                  </div>
                </div>
              )}
            </section>
